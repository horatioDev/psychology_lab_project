  ...
  const html = `
    ...
    <html>
      ...
      <body style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
        ...
        <p>Thanks for signing up. Your Psycholgy Lab account is ready.</p>
        ...
        <p style="color: #6b7280; font-size: 14px;">
          - The Psycholgy Lab Team
        </p>
      </body>
    </html>
  `;

  const text = `Welcome, ${name}! Thanks for signing up. Your Psycholgy Lab account is ready.`;
